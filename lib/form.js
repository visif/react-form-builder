...
var ReactForm = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(ReactForm, [{
    ...
    value: function validateForm() {
      ...
      var errors = [];
      var data_items = this.props.data; // get all input items

      var formItems = this._collectFormItems(this.props.data);
      ...
      if (sectionItems.length > 0) {
        ...
        var keys = Object.keys(sectionGroup);
        keys.forEach(function (key) {
          var items = sectionGroup[key];
          var fillingItems = items.find(function (item) {
