...
var ReactForm = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactForm(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleVariableChange", function (params) {
    ...
    _this.handleAutoSave = _this.handleAutoSave.bind((0, _assertThisInitialized2["default"])(_this));
    _this.state = {
      answerData: {},
      variables: {},
      prevAnswerDataProp: undefined,
      // ensure it differs from null/undefined if needed
      isInitialized: false
    };
    return _this;
  }
  (0, _createClass2["default"])(ReactForm, [{
    ...
    key: "_getSessionKey",
    value: function _getSessionKey() {
      var _this$props2 = this.props,
        sessionKey = _this$props2.sessionKey,
        form_action = _this$props2.form_action,
        task_id = _this$props2.task_id;
      return sessionKey || task_id || form_action || 'react-form-builder-session';
    }
  }, {
    key: "handleAutoSave",
    value: function handleAutoSave() {
      var _this2 = this;
      if (!this.props.saveSessionStorage || typeof window === 'undefined' || !window.sessionStorage) return;
      if (this.autoSaveTimeout) {
        clearTimeout(this.autoSaveTimeout);
      }
      this.autoSaveTimeout = setTimeout(function () {
        try {
          var data = _this2._collectFormData(_this2.props.data);
          if (data && data.length > 0) {
            window.sessionStorage.setItem(_this2._getSessionKey(), JSON.stringify(data));
          }
        } catch (e) {
    ...
    value: function _optionsDefaultValue(item) {
      ...
      item.options.forEach(function (option) {
        if (_this3.state.answerData["option_".concat(option.key)]) {
    ...
    value: function _collectFormItems(data) {
      ...
      var formData = [];
      data.forEach(function (item) {
        var itemValue = _this5._collect(item);
        var itemData = {
          id: item.id,
          element: item.element,
    ...
    value: function handleSubmit(e) {
      ...
      if (onSubmit) {
        ...
        if (errors.length < 1) {
          if (this.props.saveSessionStorage && typeof window !== 'undefined' && window.sessionStorage) {
    ...
    value: function validateForm() {
      ...
      this.props.data.forEach(function (item) {
        var childItems = _this6.props.data.filter(function (child) {
      ...
      data_items.forEach(function (item) {
        if (item.element === 'Signature') {
          _this6._getSignatureImg(item);
        }
        if (_this6._isInvalid(item)) {
          errors.push("".concat(item.label || item.position, " is required!"));
        }
        if (_this6.props.validateForCorrectness && _this6._isIncorrect(item)) {
    ...
    value: function render() {
      ...
      (_data_items = data_items) === null || _data_items === void 0 ? void 0 : _data_items.forEach(function (item) {
        if (item && item.readOnly && item.variableKey && _this10.props.variables[item.variableKey]) {
          _this10.state.answerData[item.field_name] = _this10.props.variables[item.variableKey];
        }
      });
        ...
        switch (item.element) {
          ...
          case 'DataSource':
            return /*#__PURE__*/_react["default"].createElement(DataSource, {
              ...
              ref: function ref(c) {
                _this10.inputs[item.field_name] = c;
              },
              mutable: true,
              key: "form_".concat(item.id),
              data: item,
              ...
              editor: _this10._getEditor(item),
              getDataSource: _this10.props.getDataSource,
              getActiveUserProperties: _this10.props.getActiveUserProperties,
              emitter: _this10.emitter
            });
          case 'CustomElement':
            return _this10.getCustomElement(item);
          case 'FourColumnRow':
            return _this10.getContainerElement(item, _multiColumn.FourColumnRow);
          case 'ThreeColumnRow':
            return _this10.getContainerElement(item, _multiColumn.ThreeColumnRow);
          case 'TwoColumnRow':
            return _this10.getContainerElement(item, _multiColumn.TwoColumnRow);
          case 'DynamicColumnRow':
            return _this10.getContainerElement(item, _multiColumn.DynamicColumnRow);
          case 'Signature':
            return /*#__PURE__*/_react["default"].createElement(Signature, {
              ref: function ref(c) {
                return _this10.inputs[item.field_name] = c;
              },
          ...
          case 'FileUpload':
            return /*#__PURE__*/_react["default"].createElement(FileUpload, {
              ...
              data: item,
              defaultValue: _this10._getDefaultValue(item),
              onUploadFile: _this10.props.onUploadFile,
              onDownloadFile: _this10.props.onDownloadFile,
              editor: _this10._getEditor(item),
              getActiveUserProperties: _this10.props.getActiveUserProperties
            });
          case 'FormLink':
            return /*#__PURE__*/_react["default"].createElement(FormLink, {
              ...
              defaultValue: _this10._getDefaultValue(item),
              onUploadFile: _this10.props.onUploadFile,
              onSelectChildForm: _this10.props.onSelectChildForm,
              getFormInfo: _this10.props.getFormInfo,
              onDownloadFile: _this10.props.onDownloadFile,
              editor: _this10._getEditor(item),
              getActiveUserProperties: _this10.props.getActiveUserProperties,
              parentElementId: _this10.props.parentElementId
            });
          case 'ImageUpload':
            return /*#__PURE__*/_react["default"].createElement(ImageUpload, {
              ...
              data: item,
              defaultValue: _this10._getDefaultValue(item),
              onUploadImage: _this10.props.onUploadImage,
              editor: _this10._getEditor(item),
              getActiveUserProperties: _this10.props.getActiveUserProperties
            });
          default:
    ...
    value: function getDerivedStateFromProps(props, state) {
      if (!state.isInitialized || props.answer_data !== state.prevAnswerDataProp) {
        var dbData = convert(props.answer_data);
        var sessionDataObj = {};
        if (props.saveSessionStorage && typeof window !== 'undefined' && window.sessionStorage) {
          var sessionKey = props.sessionKey || props.task_id || props.form_action || 'react-form-builder-session';
          var stored = window.sessionStorage.getItem(sessionKey);
          if (stored) {
            try {
        ...
        var ansData = _objectSpread(_objectSpread({}, dbData), sessionDataObj);
        return {
          isInitialized: true,
