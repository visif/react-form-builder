...
var ReactForm = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactForm(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleChange", function (propKey, value) {
      ...
      if (_this.formContext && _this.formContext.setFieldValue) {
        _this.formContext.setFieldValue(propKey, value);
      }
    });
    ...
    _this.formContext = props.formContext;
    console.log('ReactForm constructor - formContext instance:', _this.formContext);
    return _this;
  }
  (0, _createClass2["default"])(ReactForm, [{
    ...
    value: function _getItemValue(item, ref) {
      ...
      if (item.element === 'Rating') {
        ...
        var elementId = item.field_name || item.formularKey || "formula_".concat(item.id);
        if (this.formContext) {
          console.log('FormulaInput form context is not null:', this.formContext);
          var contextValue = this.formContext.getInputValue(elementId);
          var contextMetadata = this.formContext.getInputMetadata(elementId);
          $item.value = {
            formula: (contextMetadata === null || contextMetadata === void 0 ? void 0 : contextMetadata.formula) || item.formula,
            value: contextValue || '',
          ...
          $item.value = ref !== null && ref !== void 0 && ref.state ? {
    ...
    value: function _collect(item) {
      ...
      if (item.element === 'FormulaInput') {
        var _this$state$formProvi;
        var elementId = item.field_name || "formula_".concat(item.id);
        ...
        var contextValue = (_this$state$formProvi = this.state.formProviderValues) === null || _this$state$formProvi === void 0 ? void 0 : _this$state$formProvi[elementId];
      ...
      if ((item.element === 'Checkboxes' || item.element === 'RadioButtons') && !!ref) {
        ...
        if (item.element === 'Signature2') {
          ...
          itemData.editor = oldEditor ? oldEditor : valueItem.value && valueItem.value.value ? activeUser : null;
        }
      }
      return itemData;
    }
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      var variables = state !== null && state !== void 0 && state.variables ? state.variables : ReactForm.prototype._getVariableValue.call({
        props: props
      }, ansData, props.data);
      ...
      if (props.formProviderValues && JSON.stringify(props.formProviderValues) !== JSON.stringify(state.formProviderValues)) {
...
function ReactFormWithContext(props) {
  var formContext = (0, _FormProvider.useFormInput)();

  // Subscribe to context values - component will re-render when they change
  var formProviderValues = formContext.values || {};
  var formProviderMetadata = formContext.metadata || {};
  console.log('ReactFormWithContext - formProviderValues updated:', formProviderValues);
  return /*#__PURE__*/_react["default"].createElement(ReactForm, (0, _extends2["default"])({}, props, {
...
var ReactFormWithProvider = function ReactFormWithProvider(props) {
  return /*#__PURE__*/_react["default"].createElement(_FormProvider.FormProvider, {
    initialValues: props.initialValues || {},
    initialMetadata: props.initialMetadata || {}
  }, /*#__PURE__*/_react["default"].createElement(ReactFormWithContext, props));
};
var _default = ReactFormWithProvider;
