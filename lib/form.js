...
var ReactForm = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  function _isIncorrect(item) {
    ...
    if (item.canHaveAnswer) {
      var _ref = inputsRef.current[item.field_name];
      if (item.element === "Checkboxes" || item.element === "RadioButtons") {
        ...
        var $item = _getItemValue(item, _ref);
        if (item.element === "Rating") {
  ...
  function _isInvalid(item) {
    ...
    if (item.required === true) {
      var _ref2 = inputsRef.current[item.field_name];
      if (item.element === "Checkboxes" || item.element === "RadioButtons") {
        var dataVal = formValues[item.field_name] && formValues[item.field_name].value || [];
        var checkedItems = dataVal.find(function (item) {
          return item.value;
        });
        if (!checkedItems) {
          invalid = true;
        ...
        var $item = _getItemValue(item, _ref2);
        if (item.element === "Rating") {
          if ($item.value === 0) {
            invalid = true;
          }
      ...
      reverseKeys.forEach(function (key) {
        ...
        if (key && !activeSectionFound) {
          fillingItems = items.find(function (item) {
            return item.element !== "Table" && (Array.isArray(item.value) && item.value.length > 0 || (0, _typeof2["default"])(item.value) !== "object" && !Array.isArray(item.value) && !!item.value || item.element === "FileUpload" && item.value.fileList && item.value.fileList.length > 0 || item.element === "ImageUpload" && !!item.value.filePath);
          });
  ...
  function renderForm() {
    ...
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_formValidator["default"], {
      emitter: emitter
...
var ReactFormWrapper = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  return /*#__PURE__*/_react["default"].createElement(_formContext.FormProvider, null, /*#__PURE__*/_react["default"].createElement(ReactForm, (0, _extends2["default"])({}, props, {
    ref: ref
  })));
});
ReactFormWrapper.defaultProps = {
  validateForCorrectness: false
};
var _default = ReactFormWrapper; // export default ReactForm;
