...
var ReactForm = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(ReactForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      if (errors.length < 1) {
        var onSubmit = this.props.onSubmit; // const debugData = this._collectFormData(this.props.data);
    ...
    value: function getInputElement(item) {
      ...
      return /*#__PURE__*/_react["default"].createElement(Input, {
        ...
        ref: function ref(c) {
          _this5.inputs[item.field_name] = c;
        },
        mutable: true,
    ...
    value: function render() {
      ...
      data_items.forEach(function (item) {
        if (item && item.readOnly && item.variableKey && _this8.props.variables[item.variableKey]) {
          _this8.state.answerData[item.field_name] = _this8.props.variables[item.variableKey];
        }
      });
