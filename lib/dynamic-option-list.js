...
var DynamicOptionList = exports["default"] = /*#__PURE__*/function (_React$Component) {
  function DynamicOptionList(props) {
    ...
    (0, _defineProperty2["default"])(_this, "handleOptionDefault", function (optionIndex) {
      ...
      _this.setState(function (prevState) {
        ...
        if (typeof console !== 'undefined') {
          ...
          console.log('[DynamicOptionList] handleOptionInfo - calling updateElement', {
            ...
            options: element === null || element === void 0 || (_element$options2 = element.options) === null || _element$options2 === void 0 || (_element$options2$map = _element$options2.map) === null || _element$options2$map === void 0 ? void 0 : _element$options2$map.call(_element$options2, function (o) {
              return {
                text: o.text,
                value: o.value
              };
      ...
      if (dirty) {
        ...
        if (typeof console !== 'undefined') {
          ...
          console.log('[DynamicOptionList] updateOption - calling updateElement', {
            ...
            options: element === null || element === void 0 || (_element$options3 = element.options) === null || _element$options3 === void 0 || (_element$options3$map = _element$options3.map) === null || _element$options3$map === void 0 ? void 0 : _element$options3$map.call(_element$options3, function (o) {
              return {
                text: o.text,
                value: o.value
              };
    ...
    _this.state = (0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])({
      element: _objectSpread(_objectSpread({}, _this.props.element), {}, {
        options: _this.props.element.options || []
      })
    }, "element", _objectSpread(_objectSpread({}, _this.props.element), {}, {
      options: _this.props.element.options || []
    })), "data", _this.props.data), "dirty", false);
  ...
  return (0, _createClass2["default"])(DynamicOptionList, [{
    ...
    value: function render() {
      ...
      var _this$state4 = this.state,
        element = _this$state4.element,
        dirty = _this$state4.dirty;
