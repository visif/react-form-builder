...
var FormLink = /*#__PURE__*/function (_React$Component) {
  ...
  function FormLink(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "checkForValue", function () {
      ...
      var maxRetries = 3;
      if (!_this.state.selectedForm && defaultValue !== null && defaultValue !== void 0 && defaultValue.selectedForm) {
        setTimeout(function () {
          if (_this.mounted && !_this.state.selectedForm) {
            _this.setState({
            ...
            if (!_this.state.selectedForm && attempt < maxRetries) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "openLinkedForm", function () {
      var selectedForm = _this.state.selectedForm;
      if (selectedForm && _this.props.openLinkedForm) {
        _this.props.openLinkedForm(selectedForm);
      }
    });
    ...
    _this.state = {
      ...
      selectedForm: _defaultValue.selectedForm,
  ...
  (0, _createClass2["default"])(FormLink, [{
    ...
    value: function render() {
      ...
      var formTitle = this.state.selectedForm ? this.state.selectedForm.title : 'Select a form';
      var isFormSelected = !!this.state.selectedForm;
      ...
      }, formTitle)), this.props.mutable && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, isFormSelected ? /*#__PURE__*/_react["default"].createElement("span", null, formTitle) : /*#__PURE__*/_react["default"].createElement("span", {
        style: {
          color: '#6c757d'
        }
      }, "Select a form..."))), /*#__PURE__*/_react["default"].createElement("div", {
        style: {
          position: 'absolute',
          zIndex: 99,
          top: '100%',
    ...
    value: function getDerivedStateFromProps(props, state) {
      if (props.defaultValue && JSON.stringify(props.defaultValue.selectedForm) !== JSON.stringify(state.defaultSelectedForm)) {
