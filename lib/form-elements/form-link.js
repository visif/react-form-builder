...
var FormLink = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(FormLink, [{
    ...
    value: function render() {
      ...
      var formTitle = this.state.selectedFormId ? this.state.selectedFormId.title : this.props.mutable ? 'Select a form' : 'No form selected';
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        onClick: function onClick(e) {
          ...
          if ((_this3$state$selected = _this3.state.selectedFormId) !== null && _this3$state$selected !== void 0 && _this3$state$selected.id) {
            console.log("Form link clicked with ID: ".concat(_this3.state.selectedFormId.id));
      ...
      }, (_this$state$selectedF2 = this.state.selectedFormId) !== null && _this$state$selectedF2 !== void 0 && _this$state$selectedF2.id ? "".concat(this.state.selectedFormId.id, " - ").concat(this.state.selectedFormId.title) : this.props.data.label || 'View Form')), this.props.mutable && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
