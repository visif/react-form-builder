...
var FormLink = /*#__PURE__*/function (_React$Component) {
  ...
  function FormLink(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "openLinkedForm", function () {
      ...
      console.info('Select form: ' + ((_this$state$selectedF = _this.state.selectedFormId) === null || _this$state$selectedF === void 0 ? void 0 : _this$state$selectedF.title));
      if (_this.state.selectedFormId && _this.props.openLinkedForm) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        onClick: function onClick(e) {
          e.preventDefault();
          try {
            if (typeof _this3.props.onSelectChildForm === 'function' && _this3.props.data.formSource) {
