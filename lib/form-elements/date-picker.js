...
var DEFAULT_DATE_FORMAT = "dd MMMM yyyy";
var DatePicker = /*#__PURE__*/function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleChange", function (dt) {
      ...
      var formatMask = DEFAULT_DATE_FORMAT.formatMask;
      if (dt && dt.target) {
    ...
    _this.state = DatePicker.updateDateTime(props, DEFAULT_DATE_FORMAT);
    return _this;
  }
  (0, _createClass2["default"])(DatePicker, [{
    ...
    value: function render() {
      ...
      var placeholderText = DEFAULT_DATE_FORMAT.toLowerCase();
    ...
    value: function updateDateTime(props, formatMask) {
      ...
      if (defaultToday && (props.defaultValue === "" || props.defaultValue === undefined)) {
        ...
        if (value === "" || value === undefined) {
          ...
          internalValue = (0, _dateFns.parse)(value, formatMask, new Date());
        }
      }
      return {
        value: value,
    ...
    value: function getDerivedStateFromProps(props, state) {
      var _DatePicker$updateFor = DatePicker.updateFormat(props,
        // state.formatMask
        DEFAULT_DATE_FORMAT),
        updated = _DatePicker$updateFor.updated,
      ...
      if (updated || props.data.defaultToday !== state.defaultToday || state.defaultValue !== props.defaultValue) {
        var newState = DatePicker.updateDateTime(props, DEFAULT_DATE_FORMAT);
        return newState;
      }
      return null;
    }
