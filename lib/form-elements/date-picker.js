...
exports.getDateFormat = exports.getCalendarType = exports.default = exports.BuddhistLocale = void 0;
...
var _th_TH = _interopRequireDefault(require("antd/es/date-picker/locale/th_TH"));
...
_dayjs.default.locale(_th.default);
...
var BuddhistLocale = _objectSpread(_objectSpread({}, _th_TH.default), {}, {
  lang: _objectSpread(_objectSpread({}, _th_TH.default.lang), {}, {
...
exports.BuddhistLocale = BuddhistLocale;
var DatePicker = /*#__PURE__*/function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "formatDate", function (date, formatMask) {
      ...
      var showTimeSelect = _this.props.data.showTimeSelect;
      var updatedFormat = formatMask;
      if (showTimeSelect && !formatMask.includes('HH:mm')) {
        updatedFormat = "".concat(formatMask, " HH:mm");
      }
      if (getCalendarType() === 'EN') {
        return (0, _dayjs.default)(date).utc(true).format(updatedFormat);
      } else {
        // For Buddhist calendar, use BBBB format and ensure dayjs has buddhistEra plugin
        var buddhistFormat = updatedFormat.replace('YYYY', 'BBBB');
        return (0, _dayjs.default)(date).utc(true).format(buddhistFormat);
      }
    });
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        style: {
          ...
          width: showTimeSelect ? '210px' : 'auto'
        }
        ...
        format: function () {
          var format = _this2.state.formatMask;
          if (showTimeSelect && !format.includes('HH:mm')) {
            format = "".concat(format, " HH:mm");
          }
