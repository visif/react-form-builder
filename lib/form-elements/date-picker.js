  ...
  constructor(props) {
    ...
    (0, _defineProperty2.default)(this, "handleChange", date => {
      ...
      if (date) {
        ...
        lockedDate = (0, _dayjs.default)(lockedDate).toISOString();
      }
  ...
  static updateDateTime(props, formatMask) {
    ...
    if (defaultToday && !props.defaultValue) {
      ...
      try {
        ...
        let parsedDate = (0, _dayjs.default)(props.defaultValue, formatMask);
        if (parsedDate.isValid()) {
          ...
          let fallbackDate = (0, _dayjs.default)(props.defaultValue);
