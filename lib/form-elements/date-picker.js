  ...
  static updateDateTime(props, formatMask) {
    ...
    if (defaultToday && !props.defaultValue) {
      ...
      try {
        ...
        value = (0, _dayjs.default)(props.defaultValue, formatMask).isValid() ? _dayjs.default.utc((0, _dayjs.default)(props.defaultValue, formatMask).format('YYYY-MM-DDTHH:mm:ss')).toISOString() : _dayjs.default.utc((0, _dayjs.default)(props.defaultValue).format('YYYY-MM-DDTHH:mm:ss')).toISOString();
      } catch (error) {
