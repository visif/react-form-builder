...
var DataSource = /*#__PURE__*/function (_React$Component) {
  function DataSource(props) {
    ...
    _this = _callSuper(this, DataSource, [props]);
    ...
    (0, _defineProperty2["default"])(_this, "notifyParentOfInitialization", function () {
    ...
    (0, _defineProperty2["default"])(_this, "getDataSourceConfigKey", function (data) {
      return JSON.stringify({
        sourceType: data === null || data === void 0 ? void 0 : data.sourceType,
        formSource: data === null || data === void 0 ? void 0 : data.formSource,
        fields: Object.keys(data || {}).filter(function (key) {
          return key.startsWith('formField');
    ...
    (0, _defineProperty2["default"])(_this, "handleSelectItem", function (item) {
    ...
    (0, _defineProperty2["default"])(_this, "updateFromSync", function (syncData) {
  ...
  return (0, _createClass2["default"])(DataSource, [{
    ...
    value: function render() {
      ...
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(this.state.searchText, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {
        type: 'text',
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          onClick: function onClick() {
            return _this3.handleSelectItem(item);
          }
        }, item.name);
      })))));
    }
