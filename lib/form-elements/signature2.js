...
var Signature2 = /*#__PURE__*/function (_React$Component) {
  function Signature2(props) {
    ...
    (0, _defineProperty2["default"])(_this, "clickToSign", function () {
      ...
      var notifySignedChange = function notifySignedChange() {
        if (typeof _this.props.onSignChange === 'function') {
          _this.props.onSignChange();
        }
      };
...
(0, _defineProperty2["default"])(Signature2, "getDerivedStateFromProps", function (props, state) {
  ...
  if (props.defaultValue) {
    ...
    var propsChanged = propsIsSigned !== state.prevPropsIsSigned || propsSignedPerson !== state.prevPropsSignedPerson || propsSignedPersonId !== state.prevPropsSignedPersonId || propsSignedDateTime !== state.prevPropsSignedDateTime;
    if (propsChanged) {
      return {
