...
var Table = exports["default"] = /*#__PURE__*/function (_React$Component) {
  function Table(props) {
    ...
    (0, _defineProperty2["default"])(_this, "renderRows", function () {
      ...
      var hasValue = _this.state.inputs && Object.keys(_this.state.inputs).some(function (key) {
        return _this.state.inputs[key] && Object.values(_this.state.inputs[key]).some(function (val) {
          ...
          if (isLabel) {
            return /*#__PURE__*/_react["default"].createElement("td", null, /*#__PURE__*/_react["default"].createElement("span", {
              dangerouslySetInnerHTML: {
                __html: _this.getSafeHeaderHtml(_this.state.rowLabels[i].text)
              }
            }));
          }
    ...
    (0, _defineProperty2["default"])(_this, "getSafeHeaderHtml", function (text) {
      return String(text !== null && text !== void 0 ? text : '').replace(/<script[\s\S]*?>[\s\S]*?<\/script>/gi, '').replace(/\son\w+=("[^"]*"|'[^']*'|[^\s>]+)/gi, '').replace(/javascript:/gi, '').replace(/<p\b([^>]*)>/gi, function (match) {
        ...
        if (/\bstyle\s*=\s*"([^"]*)"/i.test(attrs)) {
          return match.replace(/\bstyle\s*=\s*"([^"]*)"/i, function (styleMatch, styleValue) {
  ...
  return (0, _createClass2["default"])(Table, [{
    ...
    value: function render() {
      ...
      var hasValue = this.state.inputs && Object.keys(this.state.inputs).some(function (key) {
        return _this2.state.inputs[key] && Object.values(_this2.state.inputs[key]).some(function (val) {
          return val && val.toString().trim() !== '';
        });
      });
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        return /*#__PURE__*/_react["default"].createElement("th", {
          ...
          dangerouslySetInnerHTML: {
            __html: _this2.getSafeHeaderHtml(col.text)
          }
        }));
