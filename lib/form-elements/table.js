...
var Table = /*#__PURE__*/function (_React$Component) {
  ...
  function Table(_props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "static", function (props, state) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderRows", function () {
      ...
      return /*#__PURE__*/_react["default"].createElement("tbody", null, Array.from(Array(Number(activeRows)).keys()).map(function (i) {
        ...
        return /*#__PURE__*/_react["default"].createElement("tr", {
          ...
          var value = isLabel ? _this.state.rowLabels[i].text : _this.state.inputs[i] ? (_this$state$inputs$i$ = _this.state.inputs[i][jIndex]) !== null && _this$state$inputs$i$ !== void 0 ? _this$state$inputs$i$ : '' : '';
    ...
    var _rowsAdded = (_props.defaultValue ? _props.defaultValue.length : Number(_props.data.rows)) - Number(_props.data.rows);

    _this.state = {
      rows: Number(_props.data.rows),
      rowLabels: _props.data.rowLabels,
      columns: _props.data.columns,
      defaultValue: _props.defaultValue,
      inputs: Table.getInputValues(_props.defaultValue, _props.data.columns, Number(_props.data.rows), _rowsAdded, _props.data.rowLabels),
