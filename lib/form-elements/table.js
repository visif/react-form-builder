...
var Table = /*#__PURE__*/function (_React$Component) {
  ...
  function Table(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderRows", function () {
      return /*#__PURE__*/_react["default"].createElement("tbody", null, Array.from(Array(Number(_this.state.inputs.length)).keys()).map(function (i) {
    ...
    var rowsAdded = props.data.columns.length - props.data.rows;
    _this.state = {
  ...
  (0, _createClass2["default"])(Table, [{
    ...
    value: function render() {
      ...
      }))), this.renderRows()), /*#__PURE__*/_react["default"].createElement("div", {
        style: {
          textAlign: 'right'
        }
...
(0, _defineProperty2["default"])(Table, "getInputValues", function () {
  ...
  var result = [];
  Array.from(Array(Number(rows + addingRows)).keys()).map(function (i) {
    var current = [];
