...
class ImageUpload extends _react.default.Component {
  ...
  render() {
    ...
    }, "Loading image...") : null), (showUploadOrReplace || showRemove) && /*#__PURE__*/_react.default.createElement("div", {
      style: {
        marginTop: 8
      }
    ...
    }), showUploadOrReplace && /*#__PURE__*/_react.default.createElement("a", {
      href: "",
    ...
    }, hasValue ? 'Replace Image' : 'Upload Image'), showRemove && /*#__PURE__*/_react.default.createElement("a", {
      href: "",
      className: "btn btn-secondary",
      style: actionStyle,
      onClick: e => {
    ...
    }, "Remove Image"))), this.state.isOpen && previewSrc && /*#__PURE__*/_react.default.createElement(_reactImageLightbox.default, {
      mainSrc: previewSrc
