...
class ImageUpload extends _react.default.Component {
  ...
  render() {
    ...
    }, "Upload Image"), showRemove && /*#__PURE__*/_react.default.createElement("a", {
      href: "",
      title: "Remove Image",
      style: _objectSpread(_objectSpread({}, actionStyle), {}, {
        color: '#ff4d4f',
        fontSize: 18,
        lineHeight: 1,
    ...
    }, /*#__PURE__*/_react.default.createElement(_icons.DeleteOutlined, null)))), this.state.isOpen && previewSrc && /*#__PURE__*/_react.default.createElement(_reactImageLightbox.default, {
      mainSrc: previewSrc
