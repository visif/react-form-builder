...
var Header = /*#__PURE__*/function (_React$Component) {
  ...
  return (0, _createClass2["default"])(Header, [{
    ...
    value: function render() {
      ...
      var rawContent = String(this.props.data.content || '').replace(/<[^>]+>/g, '').trim();
      var generateSectionID = this.props.generateSectionID;
      var sectionId = typeof generateSectionID === 'function' && rawContent ? generateSectionID(rawContent) : undefined;
...
var TextInput = /*#__PURE__*/function (_React$Component5) {
  ...
  return (0, _createClass2["default"])(TextInput, [{
    ...
    value: function render() {
      ...
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(this.state.value, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {};
      props.type = 'text';
...
var NumberInput = /*#__PURE__*/function (_React$Component6) {
  function NumberInput(props) {
    ...
    _this2 = _callSuper(this, NumberInput, [props]);
...
var TextArea = /*#__PURE__*/function (_React$Component7) {
  function TextArea(props) {
    ...
    _this3 = _callSuper(this, TextArea, [props]);
...
var Dropdown = /*#__PURE__*/function (_React$Component8) {
  function Dropdown(props) {
    ...
    _this4 = _callSuper(this, Dropdown, [props]);
    (0, _defineProperty2["default"])(_this4, "handleChange", function (selectedOption) {
      ...
      var constValue = selectedOption ? selectedOption.value : '';

      // Check if the newly selected option has info enabled
      // Use loose equality to handle type coercion (string vs number)
      var selectedOptionData = _this4.props.data.options.find(function (option) {
        return option.value == constValue;
      });
      var shouldShowInfo = selectedOptionData === null || selectedOptionData === void 0 ? void 0 : selectedOptionData.info;
      ...
      var newInfo = shouldShowInfo ? _this4.state.info : '';
      _this4.setState({
        value: constValue,
        info: newInfo
      });
    ...
    (0, _defineProperty2["default"])(_this4, "handleInfoChange", function (e) {
      _this4.setState({
        info: e.target.value
      });
    });
    _this4.inputField = /*#__PURE__*/_react["default"].createRef();
    _this4.infoField = /*#__PURE__*/_react["default"].createRef();
    var rawDefaultValue = props.defaultValue !== undefined ? props.defaultValue : (_props$data = props.data) === null || _props$data === void 0 ? void 0 : _props$data.defaultValue;
    var value = rawDefaultValue && (0, _typeof2["default"])(rawDefaultValue) === 'object' ? rawDefaultValue.value : rawDefaultValue || '';
    var info = rawDefaultValue && (0, _typeof2["default"])(rawDefaultValue) === 'object' ? rawDefaultValue.info || '' : '';
    _this4.state = {
  ...
  return (0, _createClass2["default"])(Dropdown, [{
    ...
    value: function render() {
      ...
      var selectedOption = options.find(function (option) {
        return option.value == _this5.state.value;
      });

      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(selectedOption ? selectedOption.label : this.state.value, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {};
      props.name = this.props.data.field_name;
      props.onChange = this.handleChange;
      ...
      var showInfo = selectedOption && selectedOption.info;
      var baseClasses = "".concat(this.props.data.isShowLabel !== false ? 'SortableItem rfb-item' : 'SortableItem');
      if (this.props.data.pageBreakBefore) {
        baseClasses += ' alwaysbreak';
      }
    ...
    value: function getDerivedStateFromProps(props, state) {
      var _props$data2;
      var rawDefaultValue = props.defaultValue !== undefined ? props.defaultValue : (_props$data2 = props.data) === null || _props$data2 === void 0 ? void 0 : _props$data2.defaultValue;
      ...
      if (JSON.stringify(state.defaultValue) !== JSON.stringify(rawDefaultValue)) {
        ...
        var selectedOption = (_props$data3 = props.data) === null || _props$data3 === void 0 || (_props$data3 = _props$data3.options) === null || _props$data3 === void 0 ? void 0 : _props$data3.find(function (option) {
          return option.value == value;
        });
        var shouldShowInfo = selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.info;
        return {
          defaultValue: rawDefaultValue,
          value: value,
...
var Signature = /*#__PURE__*/function (_React$Component9) {
  function Signature(props) {
    ...
    (0, _defineProperty2["default"])(_this6, "clear", function () {
      if (_this6.state.defaultValue) {
        ...
        if (_this6.props.onElementChange) {
          var updatedData = _objectSpread(_objectSpread({}, _this6.props.data), {}, {
            value: ''
          });
          _this6.props.onElementChange(updatedData);
          if (_this6.props.data.dirty === undefined || _this6.props.data.dirty) {
            updatedData.dirty = true;
            if (_this6.props.updateElement) {
              _this6.props.updateElement(updatedData);
            }
          }
        }
    ...
    (0, _defineProperty2["default"])(_this6, "handleSignatureChange", function () {
      // Only trigger if canvas is available
      if (!_this6.canvas.current) return;

      // Get the signature data
      var signatureData = _this6.canvas.current.toDataURL().split(',')[1];
  ...
  return (0, _createClass2["default"])(Signature, [{
    ...
    value: function render() {
      ...
      var hasValue = defaultValue && defaultValue.length > 0;
      var isSameEditor = true;
      if (savedEditor && savedEditor.userId && hasValue && !!userProperties) {
        isSameEditor = userProperties.userId === savedEditor.userId || userProperties.hasDCCRole === true;
      }
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(defaultValue, "\nEdited by: ").concat(savedEditor.name) : '';
...
var Tags = /*#__PURE__*/function (_React$Component0) {
  function Tags(props) {
    var _this7;
  ...
  (0, _inherits2["default"])(Tags, _React$Component0);
  return (0, _createClass2["default"])(Tags, [{
    ...
    value: function render() {
      ...
      var hasValue = this.state.value && Array.isArray(this.state.value) && this.state.value.length > 0;
      var isSameEditor = true;
      if (savedEditor && savedEditor.userId && hasValue && !!userProperties) {
        isSameEditor = userProperties.userId === savedEditor.userId || userProperties.hasDCCRole === true;
      }
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(this.state.value.map(function (v) {
...
var Checkboxes = /*#__PURE__*/function (_React$Component1) {
  function Checkboxes(props) {
    var _this8;
    (0, _classCallCheck2["default"])(this, Checkboxes);
    _this8 = _callSuper(this, Checkboxes, [props]);
    (0, _defineProperty2["default"])(_this8, "getActiveValue", function (values, key) {
  ...
  (0, _inherits2["default"])(Checkboxes, _React$Component1);
  return (0, _createClass2["default"])(Checkboxes, [{
    ...
    value: function render() {
      ...
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(this.state.value.map(function (v) {
        if (v.value) {
          var opt = _this9.props.data.options.find(function (o) {
            return o.key === v.key;
          });
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        if (_this9.props.read_only || !isSameEditor) {
          props.disabled = 'disabled';
        }
        return /*#__PURE__*/_react["default"].createElement("div", {
          className: classNames,
...
var RadioButtons = /*#__PURE__*/function (_React$Component10) {
  function RadioButtons(props) {
    var _this0;
    (0, _classCallCheck2["default"])(this, RadioButtons);
    _this0 = _callSuper(this, RadioButtons, [props]);
    (0, _defineProperty2["default"])(_this0, "getActiveValue", function (values, key) {
      return values === null || values === void 0 ? void 0 : values.find(function (item) {
        return item.key === key;
      });
    });
  ...
  return (0, _createClass2["default"])(RadioButtons, [{
    ...
    value: function render() {
      ...
      var hasValue = this.state.defaultValue && Array.isArray(this.state.defaultValue) && this.state.defaultValue.length > 0;
      var isSameEditor = true;
      if (savedEditor && savedEditor.userId && hasValue && !!userProperties) {
        isSameEditor = userProperties.userId === savedEditor.userId || userProperties.hasDCCRole === true;
      }
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(this.state.defaultValue.map(function (v) {
        if (v.value) {
          var opt = _this1.props.data.options.find(function (o) {
            return o.key === v.key;
          });
          return opt ? opt.text : v.key;
        }
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        if (_this1.props.read_only || !isSameEditor) {
          props.disabled = 'disabled';
        }
        return /*#__PURE__*/_react["default"].createElement("div", {
          className: classNames,
...
var Rating = /*#__PURE__*/function (_React$Component11) {
  ...
  (0, _inherits2["default"])(Rating, _React$Component11);
  return (0, _createClass2["default"])(Rating, [{
    ...
    value: function render() {
      ...
      var currentRating = this.props.defaultValue !== undefined ? parseFloat(this.props.defaultValue, 10) : 0;
      var hasValue = currentRating > 0;
      var isSameEditor = true;
      if (savedEditor && savedEditor.userId && hasValue && !!userProperties) {
        isSameEditor = userProperties.userId === savedEditor.userId || userProperties.hasDCCRole === true;
      }
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(currentRating, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {};
      props.name = this.props.data.field_name;
...
var HyperLink = /*#__PURE__*/function (_React$Component12) {
  function HyperLink() {
    (0, _classCallCheck2["default"])(this, HyperLink);
    return _callSuper(this, HyperLink, arguments);
  }
  (0, _inherits2["default"])(HyperLink, _React$Component12);
...
var Download = /*#__PURE__*/function (_React$Component13) {
  ...
  (0, _inherits2["default"])(Download, _React$Component13);
...
var Camera = /*#__PURE__*/function (_React$Component14) {
  ...
  (0, _inherits2["default"])(Camera, _React$Component14);
  return (0, _createClass2["default"])(Camera, [{
    ...
    value: function render() {
      ...
      var hasValue = this.state.img || this.props.defaultValue && this.props.defaultValue.length > 0;
      var isSameEditor = true;
      if (savedEditor && savedEditor.userId && hasValue && !!userProperties) {
        isSameEditor = userProperties.userId === savedEditor.userId || userProperties.hasDCCRole === true;
      }
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(this.state.img || this.props.defaultValue, "\nEdited by: ").concat(savedEditor.name) : '';
      var baseClasses = "".concat(this.props.data.isShowLabel !== false ? 'SortableItem rfb-item' : 'SortableItem');
      if (this.props.data.pageBreakBefore) {
        baseClasses += ' alwaysbreak';
      }
...
var Range = /*#__PURE__*/function (_React$Component15) {
  function Range(props) {
    var _this12;
    (0, _classCallCheck2["default"])(this, Range);
    _this12 = _callSuper(this, Range, [props]);
    (0, _defineProperty2["default"])(_this12, "changeValue", function (e) {
      var target = e.target;
      _this12.setState({
        value: target.value
      });
  ...
  (0, _inherits2["default"])(Range, _React$Component15);
  return (0, _createClass2["default"])(Range, [{
    ...
    value: function render() {
      ...
      var defaultVal = parseInt(this.props.data.default_value, 10);
      var currentVal = this.state.value;
      var hasValue = currentVal !== defaultVal && currentVal !== undefined;
      var isSameEditor = true;
      if (savedEditor && savedEditor.userId && hasValue && !!userProperties) {
        isSameEditor = userProperties.userId === savedEditor.userId || userProperties.hasDCCRole === true;
      }
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "".concat(currentVal, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {};
      var name = this.props.data.field_name;
      props.type = 'range';
