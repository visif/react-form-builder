  ...
  _createClass(Checkboxes, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        }, option.text), option.info && /*#__PURE__*/_react["default"].createElement("input", {
          type: "text",
          "class": "form-control",
          style: {
            width: "auto",
  ...
  _createClass(RadioButtons, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        if (self.props.mutable) {
          props.defaultChecked = self.state.value !== undefined && (self.state.value.indexOf(option.key) > -1 || self.state.value.indexOf(option.value) > -1);
        }
