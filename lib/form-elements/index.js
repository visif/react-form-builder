...
var Dropdown = /*#__PURE__*/function (_React$Component8) {
  ...
  function Dropdown(props) {
    ...
    var value = defaultValue && (0, _typeof2.default)(defaultValue) === 'object' ? defaultValue.value : defaultValue || '';
    var info = defaultValue && (0, _typeof2.default)(defaultValue) === 'object' ? defaultValue.info || '' : '';
    _this4.state = {
  ...
  (0, _createClass2.default)(Dropdown, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      if (JSON.stringify(state.defaultValue) !== JSON.stringify(props.defaultValue)) {
        var _props$data, _props$data$options;
        var defaultValue = props.defaultValue;
        var value = defaultValue && (0, _typeof2.default)(defaultValue) === 'object' ? defaultValue.value : defaultValue || '';
        var info = defaultValue && (0, _typeof2.default)(defaultValue) === 'object' ? defaultValue.info || '' : '';
        ...
        var selectedOption = (_props$data = props.data) === null || _props$data === void 0 ? void 0 : (_props$data$options = _props$data.options) === null || _props$data$options === void 0 ? void 0 : _props$data$options.find(function (option) {
