...
var TextInput = /*#__PURE__*/function (_React$Component5) {
  ...
  (0, _createClass2.default)(TextInput, [{
    ...
    value: function render() {
      ...
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "Value: ".concat(this.state.value, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {};
      props.type = 'text';
...
var Dropdown = /*#__PURE__*/function (_React$Component8) {
  ...
  function Dropdown(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this4), "handleChange", function (e) {
      var constValue = e && e.target ? e.target.value : e ? e.value : '';

      // Check if the newly selected option has info enabled
      // Use loose equality to handle type coercion (string vs number)
      var selectedOption = _this4.props.data.options.find(function (option) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this4), "handleInfoChange", function (e) {
      _this4.setState({
        info: e.target.value
      });
    });
  ...
  (0, _createClass2.default)(Dropdown, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        className: this.props.data.isShowLabel !== false ? 'form-group' : ''
      }, /*#__PURE__*/_react.default.createElement(_componentLabel.default, this.props), /*#__PURE__*/_react.default.createElement(_reactSelect.default, (0, _extends2.default)({}, props, {
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (JSON.stringify(state.defaultValue) !== JSON.stringify(rawDefaultValue)) {
        var _props$data3, _props$data3$options;
        var value = rawDefaultValue && (0, _typeof2.default)(rawDefaultValue) === 'object' ? rawDefaultValue.value : rawDefaultValue || '';
        var info = rawDefaultValue && (0, _typeof2.default)(rawDefaultValue) === 'object' ? rawDefaultValue.info || '' : '';
        ...
        var selectedOption = (_props$data3 = props.data) === null || _props$data3 === void 0 ? void 0 : (_props$data3$options = _props$data3.options) === null || _props$data3$options === void 0 ? void 0 : _props$data3$options.find(function (option) {
...
var Signature = /*#__PURE__*/function (_React$Component9) {
  ...
  function Signature(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this6), "handleSignatureChange", function () {
  ...
  (0, _createClass2.default)(Signature, [{
    ...
    value: function render() {
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "Value: ".concat(defaultValue, "\nEdited by: ").concat(savedEditor.name) : '';
...
var Tags = /*#__PURE__*/function (_React$Component10) {
  ...
  (0, _createClass2.default)(Tags, [{
    ...
    value: function render() {
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "Value: ".concat(this.state.value.map(function (v) {
...
var Checkboxes = /*#__PURE__*/function (_React$Component11) {
  ...
  function Checkboxes(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this8), "getActiveValue", function (values, key) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        if (self.props.mutable) {
          var _ref2, _answerItem$value;
          props.checked = (_ref2 = (_answerItem$value = answerItem === null || answerItem === void 0 ? void 0 : answerItem.value) !== null && _answerItem$value !== void 0 ? _answerItem$value : isCheckedInOptions) !== null && _ref2 !== void 0 ? _ref2 : false;
        }
...
var RadioButtons = /*#__PURE__*/function (_React$Component12) {
  ...
  function RadioButtons(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this10), "getActiveValue", function (values, key) {
      return values === null || values === void 0 ? void 0 : values.find(function (item) {
        return item.key === key;
      });
    });
  ...
  (0, _createClass2.default)(RadioButtons, [{
    ...
    value: function render() {
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "Value: ".concat(this.state.defaultValue.map(function (v) {
        if (v.value) {
          var opt = _this11.props.data.options.find(function (o) {
            return o.key === v.key;
          });
          return opt ? opt.text : v.key;
        }
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        var isCheckedInOptions = option.checked || option.selected;
        if (self.props.mutable) {
          var _ref3, _answerItem$value2;
          props.checked = (_ref3 = (_answerItem$value2 = answerItem === null || answerItem === void 0 ? void 0 : answerItem.value) !== null && _answerItem$value2 !== void 0 ? _answerItem$value2 : isCheckedInOptions) !== null && _ref3 !== void 0 ? _ref3 : false;
        }
        if (_this11.props.read_only || !isSameEditor) {
          props.disabled = 'disabled';
        }
        return /*#__PURE__*/_react.default.createElement("div", {
          className: classNames,
...
var Rating = /*#__PURE__*/function (_React$Component13) {
  ...
  (0, _createClass2.default)(Rating, [{
    ...
    value: function render() {
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "Value: ".concat(currentRating, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {};
      props.name = this.props.data.field_name;
...
var Camera = /*#__PURE__*/function (_React$Component16) {
  ...
  (0, _createClass2.default)(Camera, [{
    ...
    value: function render() {
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "Value: ".concat(this.state.img || this.props.defaultValue, "\nEdited by: ").concat(savedEditor.name) : '';
      var baseClasses = "".concat(this.props.data.isShowLabel !== false ? 'SortableItem rfb-item' : 'SortableItem');
      if (this.props.data.pageBreakBefore) {
        baseClasses += ' alwaysbreak';
      }
...
var Range = /*#__PURE__*/function (_React$Component17) {
  ...
  function Range(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this14), "changeValue", function (e) {
      var target = e.target;
      _this14.setState({
        value: target.value
      });
  ...
  (0, _createClass2.default)(Range, [{
    ...
    value: function render() {
      ...
      // Create tooltip text for editor name
      var tooltipText = savedEditor && savedEditor.name && hasValue ? "Value: ".concat(currentVal, "\nEdited by: ").concat(savedEditor.name) : '';
      var props = {};
      var name = this.props.data.field_name;
      props.type = 'range';
