...
var Checkboxes = /*#__PURE__*/function (_React$Component11) {
  ...
  function Checkboxes(props) {
    ...
    _defineProperty(_assertThisInitialized(_this7), "getActiveValue", function (values, key) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        if (self.props.mutable) {
          ...
          props.checked = (_answerItem$value = answerItem === null || answerItem === void 0 ? void 0 : answerItem.value) !== null && _answerItem$value !== void 0 ? _answerItem$value : false;
        }
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          onChange: function onChange() {
            self.setState(function (current) {
              var activeVal = self.getActiveValue(current.value, option.key);
              ...
              return _objectSpread(_objectSpread({}, current), {}, {
                value: [].concat(_toConsumableArray(current.value.filter(function (item) {
        ...
        }, option.text), props.checked && option.info && /*#__PURE__*/_react["default"].createElement("input", {
...
var RadioButtons = /*#__PURE__*/function (_React$Component12) {
  ...
  function RadioButtons(props) {
    ...
    _defineProperty(_assertThisInitialized(_this9), "getActiveValue", function (values, key) {
      return values === null || values === void 0 ? void 0 : values.find(function (item) {
        return item.key === key;
      });
    });
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        if (self.props.mutable) {
          ...
          props.checked = (_answerItem$value2 = answerItem === null || answerItem === void 0 ? void 0 : answerItem.value) !== null && _answerItem$value2 !== void 0 ? _answerItem$value2 : false;
        }
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          defaultValue: (_answerItem$info2 = answerItem.info) !== null && _answerItem$info2 !== void 0 ? _answerItem$info2 : '',
          ref: function ref(c) {
            if (c && self.props.mutable) {
              self.infos["child_ref_".concat(option.key, "_info")] = c;
            }
...
var Tables = /*#__PURE__*/function (_React$Component19) {
  _inherits(Tables, _React$Component19);

  var _super20 = _createSuper(Tables);
  ...
  function Tables(props) {
    ...
    _this9 = _super20.call(this, props);
    _this9.options = {};
    return _this9;
  }
  ...
  _createClass(Tables, [{
    ...
    value: function render() {
      ...
      var self = this;
      var classNames = 'custom-control custom-tables';
