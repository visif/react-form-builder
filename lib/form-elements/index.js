...
var _textInput = _interopRequireDefault(require("../hook/textInput"));
...
var Checkboxes = /*#__PURE__*/(0, _react.forwardRef)(function (props, _ref) {
  var _useFormContext = (0, _formElements.useFormContext)(),
  ...
  var handleChange = function handleChange(option) {
    if (isSameEditor) {
      ...
      setValue(function (current) {
        ...
        dispatch({
          type: _formElements.FORM_ACTION.UPDATE_VALUE,
          name: props.data.field_name,
          value: newVal
        });
        return newVal;
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      className: "custom-control-label",
      htmlFor: "fid_" + this_key
    }, option.text), inputProps.checked && option.info && /*#__PURE__*/_react["default"].createElement(_textInput["default"], {
      id: "fid_" + this_key + "_info",
      style: {
        width: "auto",
        marginLeft: 16,
...
function RadioButtons(props) {
  var _useFormContext2 = (0, _formElements.useFormContext)(),
...
FormElements.FileUpload = _fileUpload["default"]; // migrated, value done
FormElements.Checkboxes = Checkboxes; // migrated, value done
FormElements.RadioButtons = RadioButtons; // migrated, value done
FormElements.Signature2 = _signature["default"]; // migrated, value done
