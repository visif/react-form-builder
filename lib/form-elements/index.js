      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          onChange: function onChange() {
            self.setState(_objectSpread(_objectSpread({}, self.state), {}, {
              value: [option.key]
            }));
          }
  ...
  _createClass(RadioButtons, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        if (self.props.mutable) {
          props.checked = self.state.value !== undefined && (self.state.value.indexOf(option.key) > -1 || self.state.value.indexOf(option.value) > -1);
        }
