...
=======
    ...
    if ((_props$data = props.data) !== null && _props$data !== void 0 && _props$data.formula && props.variables) {
      ...
      newValue = ((_parser$parse = parser.parse(props.data.formula)) === null || _parser$parse === void 0 ? void 0 : _parser$parse.result) || '';
    }
    _this.state = {
      error: '',
...
=======
      var parser = new _hotFormulaParser.Parser();
      var parsedValue = parseFloat(params.value);
      var newVariables = _objectSpread({}, this.state.variables);
      if (!Number.isNaN(parsedValue)) {
        newVariables = _objectSpread(_objectSpread({}, this.state.variables), {}, (0, _defineProperty2["default"])({}, params.propKey, parsedValue));
...
>>>>>>> 41f3fbd (Refactor code style for consistency and improve readability across multiple files)
      ...
      var newValue = ((_parser$parse2 = parser.parse(formula)) === null || _parser$parse2 === void 0 ? void 0 : _parser$parse2.result) || '';
      ...
      if (props.data.formula !== state.formula || JSON.stringify(props.variables) !== JSON.stringify(state.variables)) {
        if (props.variables) {
          ...
          return _objectSpread(_objectSpread({}, state), {}, {
            variables: newVariables,
            value: ((_parser$parse3 = parser.parse(props.data.formula)) === null || _parser$parse3 === void 0 ? void 0 : _parser$parse3.result) || ''
          });
        }
      }
      return state;
