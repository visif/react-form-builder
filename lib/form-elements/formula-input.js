    ...
    value: function handleVariableChange(params) {
      ...
      this.updateTimeout = setTimeout(function () {
        _this2.setState({
          ...
          var parser = new _hotFormulaParser.Parser();
          var newVariables = _objectSpread({}, _this2.state.variables);

          // Handle empty/cleared values
          if (params.value === '' || params.value === null || params.value === undefined) {
            newVariables = _objectSpread(_objectSpread({}, _this2.state.variables), {}, (0, _defineProperty2["default"])({}, params.propKey, 0));
          } else {
            ...
            if (typeof processedValue === 'string' && processedValue.trim().endsWith('%')) {
              var numericPart = processedValue.trim().slice(0, -1);
              var parsedValue = parseFloat(numericPart);
              if (!Number.isNaN(parsedValue)) {
                newVariables = _objectSpread(_objectSpread({}, _this2.state.variables), {}, (0, _defineProperty2["default"])({}, params.propKey, parsedValue / 100));
              } else {
                newVariables = _objectSpread(_objectSpread({}, _this2.state.variables), {}, (0, _defineProperty2["default"])({}, params.propKey, 0));
              }
            } else {
              ...
              if (!Number.isNaN(_parsedValue)) {
                newVariables = _objectSpread(_objectSpread({}, _this2.state.variables), {}, (0, _defineProperty2["default"])({}, params.propKey, _parsedValue));
              } else {
                newVariables = _objectSpread(_objectSpread({}, _this2.state.variables), {}, (0, _defineProperty2["default"])({}, params.propKey, 0));
              }
            }
          ...
          var previousValue = _this2.state.value;
