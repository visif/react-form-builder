...
class DynamicColumnList extends _react.default.Component {
  constructor(props) {
    ...
    (0, _defineProperty2.default)(this, "editorStateFor", text => {
      if (text) {
        try {
    ...
    (0, _defineProperty2.default)(this, "onColumnEditorStateChange", (columnKey, editorState) => {
      this.setState(prev => ({
        editorStates: _objectSpread(_objectSpread({}, prev.editorStates), {}, {
          [columnKey]: editorState
        }),
        dirty: true
      }));
    });
    (0, _defineProperty2.default)(this, "onColumnEditorBlur", (index, columnKey) => {
      const {
        editorStates,
        element
      } = this.state;
      ...
      if (editorState) {
        ...
        const html = (0, _draftjsToHtml.default)(raw);
        const plainText = editorState.getCurrentContent().getPlainText();
        const oldValue = element.columns[index].value;
        const oldText = element.columns[index].text;
        const newVal = oldValue !== this._setValue(typeof oldText === 'string' ? oldText.replace(/<[^>]+>/g, '') : oldText) ? oldValue : this._setValue(plainText);
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
      ...
      return /*#__PURE__*/_react.default.createElement("li", {
        ...
        editorState: editorStates[option.key] || this.editorStateFor(option.text),
        onEditorStateChange: es => this.onColumnEditorStateChange(option.key, es),
