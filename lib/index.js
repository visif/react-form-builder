...
var ReactFormBuilder = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactFormBuilder(props) {
    ...
    _this.handleOpenLinkedForm = _this.handleOpenLinkedForm.bind((0, _assertThisInitialized2.default)(_this));
    return _this;
  }
  (0, _createClass2.default)(ReactFormBuilder, [{
    ...
    key: "handleOpenLinkedForm",
    value: function handleOpenLinkedForm(formId) {
      console.info("ReactFormBuilder: Opening linked form with ID ".concat(formId));
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_reactDnd.DndProvider, {
        ...
        style: (_ref = {
          ...
          bottom: 0,
          overflowY: 'auto'
        }, (0, _defineProperty2.default)(_ref, "position", 'sticky'), (0, _defineProperty2.default)(_ref, "paddingLeft", '15px'), (0, _defineProperty2.default)(_ref, "height", '100%'), (0, _defineProperty2.default)(_ref, "scrollbarWidth", 'none'), _ref)
