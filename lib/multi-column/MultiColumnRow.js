...
var _componentLabel = _interopRequireWildcard(require("../form-elements/component-label"));
...
const MultiColumnRow = props => {
  ...
  const baseClasses = "SortableItem rfb-item ".concat(pageBreakBefore ? 'alwaysbreak' : '').concat(data.element === 'DynamicColumnRow' ? ' rfb-dcr' : '');
  ...
  }), column.required && /*#__PURE__*/_react.default.createElement(_componentLabel.RequiredBadge, null))))), /*#__PURE__*/_react.default.createElement("tbody", null, childItems.map((row, rowIndex) => /*#__PURE__*/_react.default.createElement("tr", {
