...
var DynamicColumnRow = function DynamicColumnRow(_ref2) {
  var _workingData$columns;
  var data = _ref2.data,
    class_name = _ref2.class_name,
    rest = (0, _objectWithoutProperties2.default)(_ref2, _excluded2);
  // Don't use default parameter, handle undefined data explicitly
  var workingData = data || {};
  var rows = Number(workingData.rows) || 1;
  var columns = ((_workingData$columns = workingData.columns) === null || _workingData$columns === void 0 ? void 0 : _workingData$columns.length) || 2;
