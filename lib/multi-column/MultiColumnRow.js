...
exports.TwoColumnRow =
  exports.ThreeColumnRow =
  exports.FourColumnRow =
  exports.DynamicColumnRow =
    void 0
...
var _componentHeader = _interopRequireDefault(
  require('../form-elements/component-header')
)
...
var _useSyncColumnChanges = _interopRequireDefault(
  require('../hooks/useSyncColumnChanges')
)
...
var MultiColumnRow = function MultiColumnRow(props) {
  ...
  var syncColumnChanges = (0, _useSyncColumnChanges['default'])(
    childItems,
    getDataById,
    updateElement
  )
  ...
  var header = /*#__PURE__*/ _react['default'].createElement(
    _componentHeader['default'],
    props
  )
  var headerWithHandle = connectDragSource
    ? connectDragSource(
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      'div',
      null,
      /*#__PURE__*/ _react['default'].createElement(_componentLabel['default'], props),
      /*#__PURE__*/ _react['default'].createElement(
        'table',
        {
        ...
        /*#__PURE__*/ _react['default'].createElement(
          'tbody',
          null,
          childItems.map(function (row, rowIndex) {
            return /*#__PURE__*/ _react['default'].createElement(
              'tr',
              {
              ...
              row.map(function (item, columnIndex) {
                ...
                return /*#__PURE__*/ _react['default'].createElement(
                  ...
                  controls
                    ? (_controls$rowIndex = controls[rowIndex]) === null ||
                      _controls$rowIndex === void 0
                      ? void 0
                      : _controls$rowIndex[columnIndex]
                    : /*#__PURE__*/ _react['default'].createElement(
                        _dustbin['default'],
                        (0, _extends2['default'])(
                          {
...
var createDynamicColumnRow = function createDynamicColumnRow() {
  return function (_ref2) {
    ...
    var columns =
      ((_data$columns = data.columns) === null || _data$columns === void 0
        ? void 0
        : _data$columns.length) || 2
