...
var renderElement = function renderElement(item, props) {
  ...
  if (['Checkboxes', 'RadioButtons', 'Dropdown', 'DataSource', 'Signature2', 'FormLink'].includes(item.element) && props.syncColumnChanges && (props.editModeOn || item.element === 'FormLink') // FormLink-specific condition here
  ) {
