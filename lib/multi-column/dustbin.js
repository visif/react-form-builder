...
var renderElement = function renderElement(item, props) {
  ...
  if (['Checkboxes', 'RadioButtons', 'Dropdown', 'DataSource', 'Signature2'].includes(item.element) && props.syncColumnChanges && props.editModeOn) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement(Element, (0, _extends2["default"])({}, elementProps, {
    key: "form_".concat(item.id),
    data: item
  })));
};
