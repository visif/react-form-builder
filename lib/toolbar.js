...
var Toolbar = function Toolbar(props) {
  ...
  (0, _react.useEffect)(function () {
    var defaultItems = buildItems(props.items, _defaultItems());
    setItems(defaultItems);
    var unsubscribe = _store["default"].subscribe(function (state) {
  ...
  var _defaultItemColumns = function _defaultItemColumns() {
    return [{
      text: "Column1",
  ...
  var _defaultItems = function _defaultItems() {
    return [{
      key: "Header",
      name: "Header Text",
      icon: "fas fa-heading",
  ...
  var create = function create(item) {
    ...
    if (item.key === "Table") {
      ...
      if (item.columns.length > 0) {
        ...
        elementOptions.columns = _defaultItemColumns();
      }
    ...
    if (item.key === "FileUpload") {
      // Additional options for FileUpload
    }
    return elementOptions;
  };
  ...
  }, /*#__PURE__*/_react["default"].createElement("h4", null, "Toolbox"), /*#__PURE__*/_react["default"].createElement("ul", null, items.map(function (item) {
