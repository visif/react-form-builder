...
var _toolbarDraggableItem = _interopRequireDefault(
  require("./toolbar-draggable-item")
);
...
var Toolbar = /*#__PURE__*/ (function (_React$Component) {
  ...
  function Toolbar(props) {
    ...
    _this.create = _this.create.bind(
        ...
        value: function create(item) {
          ...
          if (item.field_name) {
            elementOptions.field_name =
              item.field_name + _UUID["default"].uuid();
          }
          ...
          if (item.key === "Table") {
            ...
            if (
              ((_item$rowLabels = item.rowLabels) === null ||
              _item$rowLabels === void 0
                ? void 0
                : _item$rowLabels.length) > 0
            ) {
