...
class Toolbar extends _react.default.Component {
  ...
  create(item) {
    ...
    if (item.key === 'Table' || item.key === 'DynamicColumnRow') {
      ...
      if (item.key === 'DynamicColumnRow') {
        var _this$state$store;
        const existing = ((_this$state$store = this.state.store) === null || _this$state$store === void 0 || (_this$state$store = _this$state$store.payload) === null || _this$state$store === void 0 ? void 0 : _this$state$store.data) || [];
        elementOptions.uniqueName = (0, _dynamicColumnRowNames.nextDynamicColumnRowUniqueName)(existing);
      }
    }
    if (item.key === 'Section') {
  ...
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement("h4", null, "Toolbox"), /*#__PURE__*/_react.default.createElement("ul", null, this.state.items.map(item => /*#__PURE__*/_react.default.createElement(_toolbarDraggableItem.default, {
      data: item,
      key: item.key,
