...
var _Toolbar = function Toolbar(props) {
  var items = buildItems(props.items, _defaultItems());
  ...
  _react["default"].useEffect(function () {
    var unsubscribe = _store["default"].subscribe(function (storeState) {
      setState({
        store: storeState
      });
    });
  ...
  var create = _react["default"].useCallback(function (item) {
    var elementOptions = {
    ...
    if (item.options) {
      if (item.options.length > 0) {
        ...
        elementOptions.options = _Toolbar._defaultItemOptions(elementOptions.element);
      }
    }
    if (item.key === 'Table' || item.key === 'DynamicColumnRow') {
      ...
      if (item.columns.length > 0) {
        ...
        elementOptions.columns = _Toolbar._defaultItemColumns();
      }
  ...
  var _onClick = _react["default"].useCallback(function (item) {
  ...
  }, /*#__PURE__*/_react["default"].createElement("h4", null, "Toolbox"), /*#__PURE__*/_react["default"].createElement("ul", null, state.items.map(function (item) {
...
_Toolbar._defaultItemOptions = function (element) {
  switch (element) {
    case 'Dropdown':
      return [{
        value: '1',
...
_Toolbar._defaultItemColumns = function () {
  return [{
    text: 'Column1',
...
var _default = exports["default"] = _Toolbar;