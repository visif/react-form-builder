    ...
    value: function create(item) {
      ...
      if (item.key === 'Table' || item.key === 'DynamicColumnRow') {
        ...
        if (item.key === 'DynamicColumnRow') {
          ...
          var existing = ((_this$state$store = this.state.store) === null || _this$state$store === void 0 || (_this$state$store = _this$state$store.payload) === null || _this$state$store === void 0 ? void 0 : _this$state$store.data) || [];
