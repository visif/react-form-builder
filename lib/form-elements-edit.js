...
class FormElementsEdit extends _react.default.Component {
  constructor(props) {
    super(props);
    (0, _defineProperty2.default)(this, "onUniqueNameChange", e => {
      const this_element = _objectSpread({}, this.latestElement || this.state.element);
    ...
    (0, _defineProperty2.default)(this, "onUniqueNameBlur", () => {
      const this_element = _objectSpread({}, this.latestElement || this.state.element);
      const sanitized = (0, _dynamicColumnRowNames.sanitizeUniqueName)(this_element.uniqueName);
      const others = this.formDesignData();
      const fallback = (0, _dynamicColumnRowNames.nextDynamicColumnRowUniqueName)(others.filter(item => item && item.id !== this_element.id));
    ...
    (0, _defineProperty2.default)(this, "onCellNameChange", e => {
      const this_element = _objectSpread({}, this.latestElement || this.state.element);
    ...
    (0, _defineProperty2.default)(this, "onCellNameBlur", () => {
      const this_element = _objectSpread({}, this.latestElement || this.state.element);
      const fallback = (0, _dynamicColumnRowNames.defaultCellName)(this_element.row, this_element.col);
      const sanitized = (0, _dynamicColumnRowNames.sanitizeCellName)(this_element.cellName);
      if (!sanitized) {
  ...
  render() {
    var _this$props$preview$g, _this$props$preview$g2, _this$props$element, _this$props$preview2, _this$props$preview3, _this$props$preview4;
    if (this.state.dirty) {
    ...
    return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
      ...
      placeholder: (0, _dynamicColumnRowNames.nextDynamicColumnRowUniqueName)(this.formDesignData().filter(item => item && item.id !== this.props.element.id)),
      ...
      className: "help-block"
    }, "Required. Used in template tags such as #Inspection_r1c1#.")), this.props.element.parentId && this.props.preview && typeof this.props.preview.getDataById === 'function' && ((_this$props$preview$g = this.props.preview.getDataById(this.props.element.parentId)) === null || _this$props$preview$g === void 0 ? void 0 : _this$props$preview$g.element) === 'DynamicColumnRow' && /*#__PURE__*/_react.default.createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/_react.default.createElement("label", {
      className: "control-label",
      htmlFor: "dcrCellName"
      ...
      className: "help-block"
    }, "Default is r", '{', "row", '}', "c", '{', "col", '}', " (e.g. r1c1). Any language is allowed. Template tag:", ' ', (0, _dynamicColumnRowNames.templateTagPreview)((_this$props$preview$g2 = this.props.preview.getDataById(this.props.element.parentId)) === null || _this$props$preview$g2 === void 0 ? void 0 : _this$props$preview$g2.uniqueName, this.state.element.cellName || (0, _dynamicColumnRowNames.defaultCellName)(this.state.element.row, this.state.element.col)))), this.props.element.hasOwnProperty('content') && this.props.element.content != null && /*#__PURE__*/_react.default.createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/_react.default.createElement("label", {
      className: "control-label"
    ...
    })))), (((_this$props$element = this.props.element) === null || _this$props$element === void 0 ? void 0 : _this$props$element.label) != null || this.props.element.element === 'Signature2' || this.props.element.element === 'ImageUpload') && /*#__PURE__*/_react.default.createElement("div", {
      className: "form-group"
      ...
      value: item.id,
      key: item.id
    }, item.name)))), (this.props.element.sourceType === 'form' || this.props.element.sourceType === 'dataset') && /*#__PURE__*/_react.default.createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/_react.default.createElement("label", {
      className: "control-label",
      htmlFor: "formSource"
    }, this.props.element.sourceType === 'dataset' ? 'Select Dataset Keys' : 'Select Fields'), this.state.activeForm && this.state.activeForm.columns && this.state.activeForm.columns.map(item => /*#__PURE__*/_react.default.createElement("div", {
      className: "custom-control custom-checkbox"
    }, /*#__PURE__*/_react.default.createElement("input", {
      id: item.field_name,
      className: "custom-control-input",
