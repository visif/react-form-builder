...
var FormElementsEdit = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(FormElementsEdit, [{
    ...
    value: function editElementProp(elemProperty, targProperty, e) {
      ...
      if (elemProperty === "sourceType" && this_element[elemProperty] === "form") {
        // call api to get form data
        var formData = this.props.getFormSource();
      ...
      if (elemProperty === "formSource" && this.state.formDataSource) {
        var activeForm = this.state.formDataSource.find(function (item) {
          return item.id == this_element[elemProperty];
        });
        this_element["formField"] = activeForm && activeForm.columns && activeForm.columns.length ? activeForm.columns[0] : null;
        this.setState(function (current) {
          return _objectSpread(_objectSpread({}, current), {}, {
    ...
    value: function render() {
      ...
      }))), this.props.element.hasOwnProperty("formField") && /*#__PURE__*/_react["default"].createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/_react["default"].createElement("label", {
        className: "control-label",
        htmlFor: "formField"
      }, "Form Field"), /*#__PURE__*/_react["default"].createElement("select", {
        className: "form-control",
        id: "formField",
        defaultValue: this.props.element.formField,
        onBlur: this.updateElement.bind(this),
        onChange: this.editElementProp.bind(this, "formField", "value")
      }, this.state.activeForm && this.state.activeForm.columns && this.state.activeForm.columns.map(function (item) {
        return /*#__PURE__*/_react["default"].createElement("option", {
          value: item,
          key: item
        }, item);
