  ...
  (0, _createClass2["default"])(FormElementsEdit, [{
    ...
    value: function () {
      var _onUploadFile = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(event) {
        var this_element, file, timeoutId, data, timeout, axiosInstance, axiosCancelSource, result, filePath, _this_element, _this_element2, _this_element3;

        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(!event || !event.target || !event.target.files || !this.props.preview.props.uploadUrl)) {
                  _context.next = 3;
                  break;
                }
              ...
              case 3:
                ...
                data.append("method", "uploadToPersonalTempDir"); //Return the file name => 000:[NUMBER].abc:XXX:YYY => 000:1450959777200100.doc:70148:2_1630413085910

                timeout = 1000 * 60 * 10; // 10 minutes,

                axiosInstance = _axios["default"].create({
                  baseURL: this.props.preview.props.uploadUrl,
                  //"http://www.isocafe.com:8080/VisiforgeDC/",
                ...
                axiosCancelSource = _axios["default"].CancelToken.source();
                timeoutId = setTimeout(function () {
                  return cancelTokenSource.cancel("HTTP timeout after ".concat(timeout, "ms."));
                }, timeout);
                _context.next = 18;
                return axiosInstance.post("UploadServlet", data, {
              ...
              case 18:
                ...
                if ((result.status === 200 || result.status === 204) && "".concat(result.data).includes('000:')) {
                  filePath = "".concat(result.data).replace('000:', '');
                  _this_element = this.state.element;
                  _this_element['src'] = filePath;
                  this.setState({
                    element: _this_element
                  });
                } else {
                  _this_element2 = this.state.element;
                  _this_element2['src'] = 'cannot upload file';
                  this.setState({
              ...
              case 23:
                ...
                _this_element3 = this.state.element;
                _this_element3['src'] = 'cannot upload file';
                this.setState({
                  element: _this_element3
                });
