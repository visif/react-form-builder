  ...
  function FormElementsEdit(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateElement", function () {
      ...
      if (typeof console !== 'undefined') {
        var _this_element$label, _this_element$label$s, _this_element$options, _this_element$options2;
        console.log('[FormElementsEdit] updateElement - saving element', {
          id: this_element === null || this_element === void 0 ? void 0 : this_element.id,
          label: this_element === null || this_element === void 0 ? void 0 : (_this_element$label = this_element.label) === null || _this_element$label === void 0 ? void 0 : (_this_element$label$s = _this_element$label.slice) === null || _this_element$label$s === void 0 ? void 0 : _this_element$label$s.call(_this_element$label, 0, 200),
          options: this_element === null || this_element === void 0 ? void 0 : (_this_element$options = this_element.options) === null || _this_element$options === void 0 ? void 0 : (_this_element$options2 = _this_element$options.map) === null || _this_element$options2 === void 0 ? void 0 : _this_element$options2.call(_this_element$options, function (o) {
            return {
              text: o.text,
              value: o.value
            };
  ...
  (0, _createClass2.default)(FormElementsEdit, [{
    ...
    value: function onEditorStateChange(property, editorState) {
      ...
      if (property === 'label' && typeof console !== 'undefined') {
        var _element$label, _element$label$slice;
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
      ...
      })), this.props.element.hasOwnProperty('content') && !['RadioButtons', 'Checkboxes', 'Dropdown'].includes(this.props.element.element) && !['RadioButtons', 'Checkboxes', 'Dropdown'].includes(this.props.element.key) && /*#__PURE__*/_react.default.createElement("div", {
        ...
        key: "option-".concat(this.state.element.options.length)
