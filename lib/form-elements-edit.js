...
var FormElementsEdit = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(FormElementsEdit, [{
    ...
    key: "nativeUploadFile",
    value: function () {
      var _nativeUploadFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(file) {
        var extension, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                data.append("Filename", "form_uuid_.".concat(extension));
                data.append("fileUpload", file);
                data.append("userID", "".concat(auth.userId));
                data.append("Upload", "Submit Query");
                data.append("method", "uploadSignature");
                _context.next = 10;
                return new HttpClient().post("UploadServlet", data);
      ...
      function nativeUploadFile(_x) {
        return _nativeUploadFile.apply(this, arguments);
      }
    ...
    key: "onUploadFile",
    value: function () {
      var _onUploadFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
        var file, _response, results, splitdot, fileNameNoExt;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.prev = 3;
                _context2.next = 6;
                return new Promise.all(nativeUploadFile(file));
              ...
              case 19:
                splitdot = file.name.split(".");
                splitdot.pop();
                fileNameNoExt = splitdot.join(".");
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "control-label",
        htmlFor: "srcImage"
      }, "Browse image file:"), /*#__PURE__*/_react["default"].createElement("input", {
        id: "srcImage",
        type: "file",
        className: "form-control",
        defaultValue: this.props.element.this_files,
        onBlur: this.updateElement.bind(this),
        onChange: this.onUploadFile.bind(this, 'src', 'value')
