  ...
  (0, _createClass2["default"])(FormElementsEdit, [{
    ...
    value: function () {
      var _onUploadFile = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(event) {
        ...
        var _this$props$preview2, this_element, _this$props$preview3, _this$props$preview3$, file, imageUrl, reader, _this_element;
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!(!event || !event.target || !event.target.files || !((_this$props$preview = this.props.preview) !== null && _this$props$preview !== void 0 && _this$props$preview.props.onImageUpload))) {
                _context.next = 3;
                break;
              }
              if (!((_this$props$preview2 = this.props.preview) !== null && _this$props$preview2 !== void 0 && _this$props$preview2.props.onImageUpload)) {
            ...
            case 3:
              ...
              _context.next = 7;
              return (_this$props$preview3 = this.props.preview) === null || _this$props$preview3 === void 0 ? void 0 : (_this$props$preview3$ = _this$props$preview3.props) === null || _this$props$preview3$ === void 0 ? void 0 : _this$props$preview3$.onImageUpload(file, this.props.element.id);
            case 7:
    ...
    value: function render() {
      var _this$props$preview4,
        _this$props$preview4$,
        _this$props$preview5,
        _this$props$preview5$,
        _this$props$preview6,
        _this$props$preview6$,
        _this5 = this;
      if (this.state.dirty) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
        ...
        data: (_this$props$preview4 = this.props.preview) === null || _this$props$preview4 === void 0 ? void 0 : (_this$props$preview4$ = _this$props$preview4.state) === null || _this$props$preview4$ === void 0 ? void 0 : _this$props$preview4$.data,
        ...
        data: (_this$props$preview5 = this.props.preview) === null || _this$props$preview5 === void 0 ? void 0 : (_this$props$preview5$ = _this$props$preview5.state) === null || _this$props$preview5$ === void 0 ? void 0 : _this$props$preview5$.data,
        updateElement: this.props.updateElement,
        preview: this.props.preview,
        element: this.props.element,
        ...
        data: (_this$props$preview6 = this.props.preview) === null || _this$props$preview6 === void 0 ? void 0 : (_this$props$preview6$ = _this$props$preview6.state) === null || _this$props$preview6$ === void 0 ? void 0 : _this$props$preview6$.data,
        updateElement: this.props.updateElement,
        preview: this.props.preview,
        element: this.props.element,
        key: "table-columns"
