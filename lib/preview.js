...
var Preview = /*#__PURE__*/function (_React$Component) {
  ...
  function Preview(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "updateState", function (newState) {
      var currentStateIndex = _this.state.history.length;
      _this.setState(function (current) {
        return {
          history: [].concat((0, _toConsumableArray2["default"])(current.history), [(0, _toConsumableArray2["default"])(newState)]),
          currentState: newState,
          index: currentStateIndex
        };
      });
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "undo", function () {
      if (_this.state.index > 0) {
        _this.setState(function (current) {
          var index = current.index;
          var history = current.history;
          var newIndex = index - 1;
          var newCurrentState = history[newIndex];
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "redo", function () {
      if (_this.state.index < _this.state.history.length - 1) {
        _this.setState(function (current) {
          var index = current.index;
          var history = current.history;
          var newIndex = index + 1;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_onChange", function (payload) {
      var answer_data = {};
