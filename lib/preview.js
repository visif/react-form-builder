...
var Preview = /*#__PURE__*/function (_React$Component) {
  ...
  function Preview(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_onChange", function (data) {
      var answer_data = {};
      data.forEach(function (item) {
        if (item && item.readOnly && _this.props.variables[item.variableKey]) {
          answer_data[item.field_name] = _this.props.variables[item.variableKey];
        }
      });
  ...
  (0, _createClass2["default"])(Preview, [{
    ...
    value: function _onDestroy(item) {
      ...
      if (item.childItems) {
        item.childItems.forEach(function (x) {
          var child = _this2.getDataById(x);
    ...
    value: function getElement(item, index) {
      ...
      return /*#__PURE__*/_react["default"].createElement(SortableFormElement, (_React$createElement = {
        id: item.id,
        key: item.id,
        seq: this.seq,
        index: index,
        ...
        isDraggable: true
      }, (0, _defineProperty2["default"])(_React$createElement, "key", item.id), (0, _defineProperty2["default"])(_React$createElement, "sortData", item.id), (0, _defineProperty2["default"])(_React$createElement, "data", item), (0, _defineProperty2["default"])(_React$createElement, "getDataById", this.getDataById), (0, _defineProperty2["default"])(_React$createElement, "setAsChild", this.setAsChild), (0, _defineProperty2["default"])(_React$createElement, "removeChild", this.removeChild), (0, _defineProperty2["default"])(_React$createElement, "_onDestroy", this._onDestroy), (0, _defineProperty2["default"])(_React$createElement, "getActiveUserProperties", this.props.getActiveUserProperties), (0, _defineProperty2["default"])(_React$createElement, "getDataSource", function getDataSource(sourceType) {
        return [];
      }), (0, _defineProperty2["default"])(_React$createElement, "onUploadFile", function onUploadFile(file) {
        return "".concat(file.name, "-").concat(Math.random() * 10000000);
      }), (0, _defineProperty2["default"])(_React$createElement, "onUploadImage", function onUploadImage(file) {
    ...
    value: function showEditForm() {
      ...
      var handleUpdateElement = function handleUpdateElement(element) {
        return _this3.updateElement(element);
      };
