...
var Preview = function Preview(props) {
      ...
      console.log('[Preview] updateElement called with', {
        ...
        label:
          element === null || element === void 0
            ? void 0
            : (_element$label = element.label) === null || _element$label === void 0
              ? void 0
              : (_element$label$slice = _element$label.slice) === null ||
                  _element$label$slice === void 0
                ? void 0
                : _element$label$slice.call(_element$label, 0, 200),
        options:
          element === null || element === void 0
            ? void 0
            : (_element$options = element.options) === null || _element$options === void 0
              ? void 0
              : (_element$options$map = _element$options.map) === null ||
                  _element$options$map === void 0
                ? void 0
                : _element$options$map.call(_element$options, function (o) {
                    return {
                      text: o.text,
                      value: o.value,
                    }
  ...
  var setAsChild = function setAsChild(item, child, row, col) {
    ...
    if (item.element === 'DynamicColumnRow') {
      ...
      (_item$element = item.element) !== null &&
      _item$element !== void 0 &&
      _item$element.includes('ColumnRow')
    ) {
  ...
  var showEditForm = function showEditForm() {
    ...
    var previewObject =
      ...
      (0, _defineProperty2['default'])(_previewObject, 'getDataById', getDataById),
  ...
  var syncRowChanges = function syncRowChanges(changedElement) {
    ...
    if (
      ...
      ((_parentElement$column = parentElement.columns) === null ||
      _parentElement$column === void 0
        ? void 0
        : _parentElement$column[changedElement.col].isSync) === false
    ) {
      return
    }
    ...
    var isSelectionChange =
      ...
      changedElement.options.some(function (opt) {
        return opt.checked
      })

    // For DataSource, only sync user selections, not initialization
    var isDataSourceUserSelection =
    ...
    parentElement.childItems.forEach(function (row, rowIndex) {
      ...
      switch (changedElement.element) {
          ...
          if (changedElement.options && itemData.options) {
            ...
            changedElement.options.forEach(function (newOpt, idx) {
              if (idx < itemData.options.length) {
                newOptions.push(
                  _objectSpread(
                    _objectSpread({}, itemData.options[idx]),
                    {},
                    {
                      text: newOpt.text,
                      value: newOpt.value,
            ...
            if (
              ...
              newOptions.some(function (opt, i) {
                var _itemData$options$i, _itemData$options$i2
                return (
                  opt.text !==
                    ((_itemData$options$i = itemData.options[i]) === null ||
                    _itemData$options$i === void 0
                      ? void 0
                      : _itemData$options$i.text) ||
                  opt.value !==
                    ((_itemData$options$i2 = itemData.options[i]) === null ||
                    _itemData$options$i2 === void 0
                      ? void 0
                      : _itemData$options$i2.value)
                )
              })
            ) {
        ...
        case 'DatePicker':
          ...
          ;['showTimeSelect', 'showTimeSelectOnly', 'defaultToday'].forEach(
            function (prop) {
              if (
                changedElement[prop] !== undefined &&
                changedElement[prop] !== itemData[prop]
