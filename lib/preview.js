...
var Preview = function Preview(props) {
  ...
  var updateElement = function updateElement(element) {
    ...
    if (typeof console !== 'undefined') {
      ...
      console.log('[Preview] updateElement called with', {
        ...
        options: element === null || element === void 0 || (_element$options = element.options) === null || _element$options === void 0 || (_element$options$map = _element$options.map) === null || _element$options$map === void 0 ? void 0 : _element$options$map.call(_element$options, function (o) {
          return {
            text: o.text,
            value: o.value
          };
  ...
  var moveCardFromCell = function moveCardFromCell(dragIdOrIndex, hoverIndex, parentId, row, col) {
    // Get the parent and clear the child reference
    var parent = getDataById(parentId);
    ...
    var dragIndex = typeof dragIdOrIndex === 'number' ? dragIdOrIndex : data.findIndex(function (x) {
      return x && x.id === dragIdOrIndex;
    });
    ...
    var newDragCard = _objectSpread({}, dragCard);
  ...
  var showEditForm = function showEditForm() {
    ...
    var previewObject = (0, _defineProperty2["default"])((0, _defineProperty2["default"])({
    ...
    }, "getDataById", getDataById), "updateElement", handleUpdateElement);
