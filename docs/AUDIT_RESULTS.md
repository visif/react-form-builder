...
> **Historical archive (2025).** The library now ships as `@visif/form-builder` with Vite 6, React 18 hooks-only components, and `dist/` as the publish target. See [README.md](../README.md) and [AGENTS.md](../AGENTS.md) for the current architecture.
