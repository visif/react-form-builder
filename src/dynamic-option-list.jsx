...
export default class DynamicOptionList extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (dirty) {
      ...
      const defaultMatch = this.props.element?.defaultValue === element?.defaultValue
  ...
  handleOptionDefault = (optionIndex) => {
    this.setState(
      (prevState) => {
        const newElement = {
          ...prevState.element,
        ...
        newElement.defaultValue = option?.value
  ...
  syncOptionsWithSameColumnElements = (options) => {
    ...
    parentElement.childItems.forEach((row, rowIndex) => {
      ...
      if (propsElement?.defaultValue !== undefined) {
  ...
  render() {
    ...
    const isDropdown = element?.element === 'Dropdown'
                  ...
                  <div className="col-sm-5">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const autoGeneratedValue = this.setValue(
                          newElement.options[index].text
                        )
                        if (
                          newElement.defaultValue === previousValue &&
                          (!newElement.options[index].value ||
                            newElement.options[index].value === autoGeneratedValue)
                        ) {
                    ...
                    (isDropdown ? (
                      <div className="col-sm-1">
                        <input
                          className="form-control"
                          type="radio"
                          name={`default_${element?.id || 'dropdown'}`}
