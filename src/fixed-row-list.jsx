...
export default class FixedRowList extends React.Component {
  ...
  editRow(index, key, e) {
    ...
    const val = (this_element.rowLabels[index].value !== this._setValue(this_element.rowLabels[index][key])) ? 
      this_element.rowLabels[index].value : this._setValue(e.target.value);
    ...
    return (
      <div className="dynamic-option-list">
        <ul key="row-labels">
          <li>
            <div className="row">
              <div className="col-sm-12"><b>Rows</b></div>
            </div>
          </li>
