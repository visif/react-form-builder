...
export default class StarRating extends React.Component {
  ...
  //     this.editing = this.props.editing || false;
...
//   const [max, setMax] = useState(props.ratingAmount || 5);
//   const [ratingCache, setRatingCache] = useState({
//     pos: props.rating ? getStarRatingPosition(props.rating) : 0,
//     rating: props.rating,
//   });
//   const [editing, setEditing] = useState(props.editing || !props.rating);
//   const [stars] = useState(5);
//   const [rating, setRating] = useState(ratingCache.rating);
//   const [pos, setPos] = useState(ratingCache.pos);
//   const [glyph, setGlyph] = useState(getStars());

//   const rootRef = useRef();
//   const ratingContainerRef = useRef();

//   useEffect(() => {
//     rootRef.current = document.querySelector(".react-star-rating__root");
//     ratingContainerRef.current = document.querySelector(
...
//     const maxWidth = ratingContainerRef.current.offsetWidth;
//     const diff = max - min;
...
//   function getStarRatingPosition(val) {
//     const width = `${getWidthFromValue(val)}%`;
//     return width;
//   }

//   function getRatingEvent(e) {
...
//   function updateRating(width, val) {
//     setPos(width);
//     setRating(val);
//   }
...
//     setRatingCache(ratngCache);

//     props.onRatingClick(e, ratngCache);
//     return true;
//   }
