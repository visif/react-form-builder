...
const FileUpload = (props) => {
  ...
  const [defaultValue, setDefaultValue] = React.useState(props.defaultValue && props.defaultValue.fileList)
  ...
  const uploadAttachFile = React.useCallback(async (file) => {
  ...
  const onUploadMultipleFiles = React.useCallback(async (event) => {
    event.persist()
  ...
  const onDownloadFile = React.useCallback(async (file) => {
  ...
  const onRemoveFile = React.useCallback((file) => {
    ...
    setFileList((current) => {
      const remainList = current.filter(
